...
| [superpowers/specs/2026-04-17-datasource-routing-and-pools.md](./superpowers/specs/2026-04-17-datasource-routing-and-pools.md) | **MySQL / Redis 命名池**；按 **`routing_key`（抽象键）** 解析；**最长前缀匹配（LPM）**；`ResolveDB` / `ResolveRedis` 语义与配置形状 |
