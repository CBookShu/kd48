...
| [superpowers/specs/2026-04-17-datasource-routing-and-pools.md](./superpowers/specs/2026-04-17-datasource-routing-and-pools.md) | **MySQL / Redis 命名池**；**`routing_key`** + **LPM**；**策略 A**（无候选即错，无隐式默认池）；`ResolveDB` / `ResolveRedis` 与配置形状 |
