...
func main() {
	...
	// 注册 ItemService 和 CheckinService
	var itemSvc *ItemService
	var checkinSvc *CheckinService
	...
	// 注册 GatewayIngress（包含所有服务的路由）
	gatewayv1.RegisterGatewayIngressServer(s, newIngressServer(lobbySvc, checkinSvc, itemSvc))
